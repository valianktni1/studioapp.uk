    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#FDFCF8' }}>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        >
          {/* Welcome Message */}
          <div className="mb-8">
            <Camera className="w-12 h-12 mx-auto mb-4 text-[var(--brand)]" strokeWidth={1.5} />
            <h1 
          ...
          >
            <Heart className="w-5 h-5 text-[var(--brand)]" fill="var(--brand)" />
          ...
          {/* Upload Zone */}
          <div
            className={`upload-zone p-8 md:p-12 cursor-pointer transition-all duration-300 ${dragOver ? 'drag-over ring-2 ring-[var(--brand)]' : ''}`}
            style={{ 
              backgroundColor: dragOver ? 'rgba(var(--brand-rgb),0.1)' : 'rgba(var(--brand-rgb),0.04)',
              borderRadius: '8px'
            }}
          ...
          >
            ...
            {uploading ? (
              <div className="w-full max-w-xs mx-auto">
                <Upload className="w-10 h-10 mx-auto mb-4 text-[var(--brand)] animate-bounce" strokeWidth={1.5} />
              ...
              <>
                <Upload className="w-14 h-14 mx-auto mb-4 text-[var(--brand)]" strokeWidth={1.5} />
                ...
                <Button
                  className="bg-[var(--brand)] text-white hover:bg-[var(--brand)]/90 rounded-sm px-8 py-3 text-sm tracking-wider uppercase font-bold"
                  style={{ fontFamily: 'Manrope, sans-serif' }}
